...
export default async function Curso(props: any) {

    const params = await props.params;

    const { data: curso } = await Api.get<CursoResponse>(`aluno/curso/${params.curso_id}`)
            ...
            <AppHeader>
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbLink href={`/pacotes/${pacote.data.id}`}>{pacote.data.nome}</BreadcrumbLink>
                        <BreadcrumbSeparator />
